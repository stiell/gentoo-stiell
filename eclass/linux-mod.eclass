...
# DESCRIPTION:
# It checks for KERNEL_MODSECKEY and KERNEL_MODPUBKEY and verifies that the files exist.
check_module_signing() {
	use module-signing || return 1

	# Check that the configuration is correct
	KERNEL_MODSECKEY=${KERNEL_MODSECKEY:-${KV_DIR}/certs/signing_key.pem}
	KERNEL_MODPUBKEY=${KERNEL_MODPUBKEY:-${KV_DIR}/certs/signing_key.x509}
